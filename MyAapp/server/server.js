...
const { Client, Intents,Discord, DiscordAPIError, MessageAttachment, Message, CommandInteractionOptionResolver } = require('discord.js');
...
client.on('ready',()=>{
    ...
    client.on('message',(receivedMessage)=>{
      ...
      //      const image=fs.readFileSync(path.join(__dirname,'./images/download.jpg'))
      //  const attachment=new MessageAttachment(image)
      //  receivedMessage.reply('Hi',attachment)
        }
    })
...
app.start = function () {
 ...
 // require('loopback').getModel('Model1').find((err,result)=>{
  //    console.log(res)
  //})
  //app.models.tradingview_alert.find((err,result)=>{
  //    console.log(result);
    //  console.log(err);
  //})
  //app.model.tradingview_alert.find((err,user)=>{
  //  if(user){
  //      console.log(user);
  //  }
  //  console.log(err);
